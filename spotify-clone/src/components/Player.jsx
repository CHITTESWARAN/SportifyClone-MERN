    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4 md:mb-[12%]'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            <div className='flex gap-4'>
                ...
                <img onClick={()=>previous(track)} className='w-4 cursor-pointer' src={assets.prev_icon} alt="" />
                {playStatus?<img onClick={pause} className='w-4 cursor-pointer' src={assets.pause_icon} alt="" />:
                 <img onClick={play} className='w-4 cursor-pointer' src={assets.play_icon} alt="" />
                }
                <img onClick={()=>next(track)} className='w-4 cursor-pointer' src={assets.next_icon} alt="" />
        ...
        <div className='hidden lg:flex items-center cursor-pointer gap-2 opacity-75'>
